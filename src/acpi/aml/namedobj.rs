...
pub fn parse_named_obj(data: &[u8]) -> Result<(NamedObj, usize), AmlError> {
...
fn parse_def_create_dword_field(data: &[u8]) -> Result<(NamedObj, usize), AmlError> {
    if data[0] != 0x8A {
...
fn parse_def_device(data: &[u8]) -> Result<(NamedObj, usize), AmlError> {
...
fn parse_def_op_region(data: &[u8]) -> Result<(NamedObj, usize), AmlError> {
...
fn parse_def_field(data: &[u8]) -> Result<(NamedObj, usize), AmlError> {
...
fn parse_field_list(data: &[u8]) -> Result<Vec<FieldElement>, AmlError> {
...
fn parse_field_element(data: &[u8]) -> Result<(FieldElement, usize), AmlError> {
...
fn parse_named_field(data: &[u8]) -> Result<(FieldElement, usize), AmlError> {
...
fn parse_reserved_field(data: &[u8]) -> Result<(FieldElement, usize), AmlError> {
    Err(AmlError::AmlParseError)
}

fn parse_access_field(data: &[u8]) -> Result<(FieldElement, usize), AmlError> {
    Err(AmlError::AmlParseError)
}

fn parse_extended_access_field(data: &[u8]) -> Result<(FieldElement, usize), AmlError> {
    Err(AmlError::AmlParseError)
}

fn parse_connect_field(data: &[u8]) -> Result<(FieldElement, usize), AmlError> {
    Err(AmlError::AmlParseError)
}

fn parse_def_method(data: &[u8]) -> Result<(NamedObj, usize), AmlError> {
    if data[0] != 0x14 {
        return Err(AmlError::AmlParseError);
    }
